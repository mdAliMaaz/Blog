...
title: 'Java methods are passed by value'
date: 'September 20, 2023'
description: 'Java methods are passed by value'
tags: ['Java']
---
...
hello is a method we defined in class Main. Notice a few things about hello.

-  **static** means this method belongs to the class Main and not to a specific instance of Main. Which means we can call the method from a different class like that Main.hello().
